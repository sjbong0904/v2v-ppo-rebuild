...
RUN_DIR = "runs"
MODEL_PATH = os.path.join(RUN_DIR, "simple_ppo.zip")


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--timesteps", type=int, default=50_000)
    parser.add_argument("--mode", default="perfect_v2v", choices=["perfect_v2v", "lossy_v2v", "sensor_only"])
    ...
    env = Monitor(SimpleIntersectionEnv(
